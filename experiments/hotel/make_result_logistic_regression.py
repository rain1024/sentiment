...
import re
from exported.logistic_regression import sentiment
from exported.logistic_regression_full import sentiment as sentiment_full
import pandas as pd
import json
...
save_result(X_test, y, "results/logistic_regression.json")
save_result(X_test, y_full, "results/logistic_regression_full.json")
...
open("results/logistic_regression_result.txt", "w").write(content)
open("results/logistic_regression_full_result.txt", "w").write(content_full)
