...
import re
from exported.gaussian import sentiment
from exported.gaussian_full import sentiment as sentiment_full
import pandas as pd
import json
...
save_result(X_test, y, "results/gaussian.json")
save_result(X_test, y_full, "results/gaussian_full.json")
...
open("results/gaussian_result.txt", "w").write(content)
open("results/gaussian_full_result.txt", "w").write(content_full)
