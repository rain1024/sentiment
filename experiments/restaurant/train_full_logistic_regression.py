...
model = LogisticRegressionModel("Logistic Regression Full data", CountVectorizer(ngram_range=(1, 2), max_features=700))
model.load_data(X, y)
model.fit_transform()
model.train()
model.evaluate(X_dev, y_dev)
model.export(folder="exported/logistic_regression_full")
